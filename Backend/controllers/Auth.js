...
exports.signUp = async (req, res) => {
  console.log("We are in backend SignUp Controller");
  try {
    // fecth the data
    const {
      firstName,
...
exports.sendOtp = async (req, res) => {
  console.log("I am in sendOTP Controller ");
  try {
    ...
    console.log(
      "Yha fat gya hai, So Come into in the auth controllers!!!",
      error.message
    );
    return res.status(500).json({
      success: false,
...
exports.changePassword = async (req, res) => {
  console.log("We are in changepassword controller ");
  try {
