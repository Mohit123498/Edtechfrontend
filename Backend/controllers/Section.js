...
exports.createSection = async (req, res) => {
  console.log("We are in create section of course controller");
  try {
...
exports.updateSection = async (req, res) => {
  console.log("We are in update section controller");
  try {
...
exports.deleteSection = async (req, res) => {
  console.log("we are in delete section by section id controller");
  try {
