...
exports.createSubSection = async (req, res) => {
  console.log("we are create subsection controller ");
  try {
...
exports.updateSubSection = async (req, res) => {
  console.log("we are in update subsection details controller ");
  try {
...
exports.deleteSubSection = async (req, res) => {
  console.log("we are in delete subsection details ");
  try {
    //step-1 fecth tha data from the body
