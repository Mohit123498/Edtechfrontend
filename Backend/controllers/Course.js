...
exports.getAllCourses = async (req, res) => {
  console.log("all courses controller");
  try {
...
exports.getCourseDetails = async (req, res) => {
  console.log("all info of single course ");
  try {
...
exports.getInstructorCourses = async (req, res) => {
  console.log(" all courses of instructor  controller ");
  try {
    ...
    if (instructorCourses.length <= 0) {
      return res.status(404).json({
        success: false,
        message: "Instrutor can not make any course yet",
      });
    }
...
exports.deleteCourse = async (req, res) => {
  console.log("we are deleting single course by their course id controller");
  try {
    const { courseId } = req.body;
...
exports.editCourse = async (req, res) => {
  console.log("we are edit course by their courseid controller");
  try {
    const { courseId } = req.body;
